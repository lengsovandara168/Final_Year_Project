...
export const TABLET_MODELS: BrandModels = {
  ...
  samsung: [
    ...
    { name: "Galaxy Tab S9 FE", slug: "galaxy-tab-s9-fe" },
    { name: "Galaxy Tab A9", slug: "galaxy-tab-a9" },
    { name: "Galaxy Tab A9+", slug: "galaxy-tab-a9-plus" },
  ],
  lenovo: [
    { name: "Tab P12 Pro", slug: "tab-p12-pro" },
    { name: "Tab P12", slug: "tab-p12" },
    { name: "Tab M10 Plus", slug: "tab-m10-plus" },
    { name: "Tab M9", slug: "tab-m9" },
  ],
  xiaomi: [
    { name: "Pad 6", slug: "mi-pad-6" },
    { name: "Pad 6 Pro", slug: "mi-pad-6-pro" },
    { name: "Pad 6 Max", slug: "mi-pad-6-max" },
  ],
};
...
export const ACCESSORY_MODELS: BrandModels = {
  ...
  samsung: [
    { name: "Galaxy Buds3", slug: "galaxy-buds3" },
    { name: "Galaxy Buds3 Pro", slug: "galaxy-buds3-pro" },
    { name: "Galaxy Watch 7", slug: "galaxy-watch-7" },
    { name: "Galaxy Watch Ultra", slug: "galaxy-watch-ultra" },
  ],
  jbl: [
    { name: "Tune 770NC", slug: "tune-770nc" },
    { name: "Live 770NC", slug: "live-770nc" },
    { name: "Clip 5", slug: "clip-5" },
    { name: "Charge 6", slug: "charge-6" },
  ],
  anker: [
    { name: "PowerCore 26800", slug: "powercore-26800" },
    { name: "PowerCore 10000", slug: "powercore-10000" },
    { name: "Nano Charger 65W", slug: "nano-charger-65w" },
    { name: "MagGo Charger", slug: "maggo-charger" },
  ],
  sony: [
